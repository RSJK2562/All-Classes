...
<head>
    ...
    <meta content="Apna-Ghar" name="keywords">
    <meta content="Apna-Ghar" name="description">
...
<body>
        ...
        <div class="container px-0">
            <nav class="navbar navbar-light bg-white navbar-expand-xl">
                <a href="index.html" class="navbar-brand">
                    <h1 class="text-primary display-6">E-Commerce</h1>
                </a>
                ...
                <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                    <div class="navbar-nav mx-auto">
                        ...
                        <a href="{{ route('web.product-details') }}" class="nav-item nav-link">Shop Detail</a>
                        {{-- <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu m-0 bg-secondary rounded-0">
                                ...
                                <a href="{{ route('web.testimonial') }}" class="dropdown-item">Testimonial</a>
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer-item">
                        ...
                        <img src="{{ asset('web/img/payment.png') }}" class="img-fluid" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        //         const $quantityInput = $(this).closest('td').find('input[name=quantity]');
        //         const requestData = {
        //             qty: $quantityInput.val(),
        //             cartId: $quantityInput.data('cart_id'),
        //             price: $quantityInput.data('price')
        //         };

        //         sendAjaxRequest("{{ route('add.cart') }}", "POST", requestData);
        //     });
        ...
        //         sendAjaxRequest("{{ route('add.cart') }}", "POST", requestData, function(response) {
        //             $('.cart_counter').text(response.cart_count);
        //         });
        //     });
        // });
