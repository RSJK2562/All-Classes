...
<head>
    ...
    <title>Gtechs – Secure Payment by Cashfree</title>
    <!-- Favicon -->
...
<body class="min-h-screen font-sans text-gray-800">
    ...
    <script>
        ...
        async function initiatePayment(e) {
            ...
            // Step 1: Create Order
            let response = await fetch('/cashfree/create-order', {
                method: 'POST',
                headers: {
            ...
            if (data.payment_session_id) {
                const cashfreeMode = "{{ config('cashfree.env') === 'production' ? 'production' : 'sandbox' }}";
